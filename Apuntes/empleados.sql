...
insert  into `oficinas`(`idOficina`,`ciudad`,`telefono`,`direccion1`,`direccion2`,`estado`,`pais`,`codigoPostal`,`territory`) values 
...
CREATE TABLE `empleados` (
  ...
  KEY `jefeDirecto` (`jefeDirecto`),
  KEY `idOficina` (`idOficina`),
  CONSTRAINT `empleados_ibfk_1` FOREIGN KEY (`jefeDirecto`) REFERENCES `empleados` (`idEmpleado`),
  CONSTRAINT `empleados_ibfk_2` FOREIGN KEY (`idOficina`) REFERENCES `oficinas` (`idOficina`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

insert  into `empleados`(`idEmpleado`,`apellidoEmpleado`,`nombreEmpleado`,`extension`,`email`,`idOficina`,`jefeDirecto`,`puesto`) values 
...
CREATE TABLE `clientes` (
  ...
  `pais` varchar(50) NOT NULL,
  `telefonoRepresentante` int(11) DEFAULT NULL,
  `limiteCredito` decimal(10,2) DEFAULT NULL,
  PRIMARY KEY (`idCliente`),
  KEY `telefonoRepresentante` (`telefonoRepresentante`),
  CONSTRAINT `clientes_ibfk_1` FOREIGN KEY (`telefonoRepresentante`) REFERENCES `empleados` (`idEmpleado`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

insert  into `clientes`(`idCliente`,`nombreCliente`,`apellidoContacto`,`nombreContacto`,`telefono`,`direccion1`,`direccion2`,`ciudad`,`estado`,`codigoPostal`,`pais`,`telefonoRepresentante`,`limiteCredito`) values 
...
insert  into `detalles_producto`(`detalle`,`descripcionTexto`,`descripcionHtml`,`imagen`) values 
...
CREATE TABLE `productos` (
  ...
  KEY `detalle` (`detalle`),
  CONSTRAINT `productos_ibfk_1` FOREIGN KEY (`detalle`) REFERENCES `detalles_producto` (`detalle`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

insert  into `productos`(`idProducto`,`nombreProducto`,`detalle`,`escala`,`fabricante`,`descripcion`,`stock`,`precio`,`precioSugerido`) values 
...
insert  into `compras`(`idCompra`,`fechaCompra`,`fechaSolicitud`,`fechaEnvio`,`status`,`comentarios`,`idCliente`) values 
...
(10118,'2003-04-21','2003-04-29','2003-04-26','Shipped','Customer has worked with some of our vendors in the past and is aware of their precioSugerido',216),
...
(10224,'2004-02-21','2004-03-02','2004-02-26','Shipped','Customer has worked with some of our vendors in the past and is aware of their precioSugerido',171),
...
(10322,'2004-11-04','2004-11-12','2004-11-10','Shipped','Customer has worked with some of our vendors in the past and is aware of their precioSugerido',363),
...
CREATE TABLE `detalles_compra` (
  ...
  CONSTRAINT `detalles_compra_ibfk_1` FOREIGN KEY (`idCompra`) REFERENCES `compras` (`idCompra`),
  CONSTRAINT `detalles_compra_ibfk_2` FOREIGN KEY (`idProducto`) REFERENCES `productos` (`idProducto`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
insert  into `detalles_compra`(`idCompra`,`idProducto`,`cantidad`,`precio`,`orderLineNumber`) values 
...
CREATE TABLE `pagos` (
  ...
  PRIMARY KEY (`idCliente`,`numeroPago`),
  CONSTRAINT `pagos_ibfk_1` FOREIGN KEY (`idCliente`) REFERENCES `clientes` (`idCliente`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

insert  into `pagos`(`idCliente`,`numeroPago`,`fechaPago`,`cantidad`) values 
